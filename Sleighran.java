...
public class Sleighran extends GCompound{
	...
	// This section creates the Mehran portion of SLeighran
		...
		add(arms, mehran.getWidth() + BODY_WIDTH * 2 - ARMS_WIDTH + 4, BODY_HEIGHT - OTHER_LEGS_HEIGHT * 3);
		...
		boots = new GRect(BOOTS_WIDTH, BOOTS_HEIGHT);
		boots.setColor(shoes);
		boots.setFilled(true);
		boots.setFillColor(shoes);
		add(boots, mehran.getWidth() + BODY_WIDTH * 3 + 1, BODY_HEIGHT - OTHER_LEGS_HEIGHT - 5);
 ...
 */
	...
	private static final int BOOTS_WIDTH = 3;
	private static final int BOOTS_HEIGHT = 10;
